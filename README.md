...
<body>
    <div class="container">
        <header class="main-info">
            <h1>Ryan Dodson</h1>
            <p>Preferred Name: Ryan Dodson</p>
            <p>Current/Recent Job Title: Helping with my Family's catering bussiness KravCatering</p>
        </header>

        <section class="career">
            <h2>Job Responsibilities</h2>
            <p>Manging Customers, Serving Food, Setting up Materials & Packing up.</p>
        </section>

        <section class="hobbies">
            <h2>Hobbies and Special Interests</h2>
            <p>I like to play video games and watch alot of cartoons and shows. Entertainment in any way has always intrested me.</p>
        </section>

        <section class="career">
            <h2>Reasons for Pursuing This Degree</h2>
            <p>I've always been interested in making games and entertainment since the end of high school so I decided to focus on what intrigues me.</p>
        </section>

        <section class="course">
            <h2>Reasons for Taking This Course</h2>
            <p>Hopefully taking this course will help me achieve the goal of becoming a game developer that can entertain a lot of people.</p>
        </section>

        <section class="fun-fact">
            <h2>Fun Fact</h2>
            <p>A fun fact you remember me by is that I almost died at sky-zone, it was pretty cool.</p>
        </section>
    </div>
</body>
</html>
